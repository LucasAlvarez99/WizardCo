...
function Header({ onOpenCart, onOpenLogin, onOpenFilters, searchQuery, setSearchQuery, onSelectCategory }) {
  ...
  return (
    <header className="site-header">
      <div className="site-header__top">
        ...
        <div className="brand">
          <div className="brand__icon"><IconLayers size={20} /></div>
              ...
              {userMenuOpen && (
                <div className="user-menu__dropdown">
                  ...
                  <div className="user-menu__item">
                    <IconPackage size={15} />
                    <span>{user.orders} compras realizadas</span>
                  </div>
                  <button
